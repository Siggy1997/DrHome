...
<body>
	<form action="/completeHosDoc" class="GroupCenter" method="post">
		<main>
			<div class="main-area">
				<span><img src="../img/DrHome_logo_side.png"
				...
				<div class="Group">
					<p>소 개</p>
					<input class="vector" type="text" placeholder="소 개" name="rdinfo">
				</div>
				<div class="gender">
					<div class="man">
						<p>남자</p>
						<input type="radio"id="rdgender" name="rdgender"
							value="0" checked>
					</div>
					<div class="woman">
						<p>여자</p>
				...
				<div class="Group">
					<p>경 력</p>
					<input class="vector" type="text" placeholder="학 력" name="rdcareer">
				</div>
				<div class="selectDpno">
					<div>진료과</div>
					<select name="dpno" class="department">
